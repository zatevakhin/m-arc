...
func appendChapter(manga *MangaInfo, chapter string, link string, index int) {
	...
	// result := utils.FindNamedMatches(defaultRegex, chapter)
	// if len(result) == 0 {
	// 	result := utils.FindNamedMatches(extraRegex, chapter)
	// 	if len(result) == 0 {
	// 		result := utils.FindNamedMatches(singleRegex, chapter)
	// 	}
	// }
	...
	// 	if len(result) == 2 {
	// 		chapterName = result[1]
	// 	} else if len(result) == 3 {
	// 		vNumber, err := strconv.Atoi(result[1])
	// 		if err != nil {
	// 			logrus.Panicln("Can't parse volume number!")
	// 		}

	// 		volumeNumber = vNumber
	// 		chapterName = result[2]
	...
	// 		cNumber, err2 := strconv.Atoi(result[2])
	// 		if err2 != nil {
	// 			logrus.Panicln("Can't parse chapter name!")
	// 		}

	// 		volumeNumber = vNumber
	// 		chapterNumber = cNumber
	// 		chapterName = result[3]
	// 	}
